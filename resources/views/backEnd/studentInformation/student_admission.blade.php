                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect">
                                    <input class="primary-input  form-control{{ $errors->has('admission_number') ? ' is-invalid' : '' }}" type="text" onkeyup="GetAdmin(this.value)" name="admission_number" value="{{$max_admission_id != ''? $max_admission_id + 1 : 1}}">
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input form-control{{ $errors->has('rfid_no') ? ' is-invalid' : '' }}" type="text" name="rfid_no" value="{{old('rfid_no')}}">
                                    <label>RFID No @if(is_required('rfid_no')==true) <span> *</span> @endif </label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-2">
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input date" id="" type="text" name="admission_date" value="{{old('admission_date') != ""? old('admission_date'):date('m/d/Y')}}" autocomplete="off">
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderPhoto" placeholder="@lang('common.student_photo')  @if(is_required('photo')==true) * @endif" readonly="">
                                            <span class="focus-border"></span>
                            ...
                            <div class="row mb-40 mt-30">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input" type="text" id="placeholderFathersName" placeholder="@lang('common.photo') @if(is_required('fathers_photo')==true) * @endif" readonly="">
                                                <span class="focus-border"></span>
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input" type="text" id="placeholderMothersName" placeholder="@lang('student.photo')  @if(is_required('mothers_photo')==true) * @endif" readonly="">
                                                <span class="focus-border"></span>
                            ...
                            <div class="row mb-40">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input" type="text" id="placeholderGuardiansName" placeholder="@lang('student.photo') @if(is_required('guardians_photo')==true) * @endif" readonly="">
                                                <span class="focus-border"></span>
                        ...
                        <div class="row mb-30">
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderFileOneName" placeholder="01  @if(is_required('document_file_1')==true) * @endif" readonly="">
                                            <span class="focus-border"></span>
                            ...
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderFileTwoName" placeholder="02 @if(is_required('document_file_2')==true) * @endif" readonly="">
                                            <span class="focus-border"></span>
                            ...
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderFileThreeName" placeholder="03 @if(is_required('document_file_3')==true) * @endif" readonly="">
                                            <span class="focus-border"></span>
                            ...
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderFileFourName" placeholder="04 @if(is_required('document_file_4')==true) * @endif" readonly="">
                                            <span class="focus-border"></span>
...
<script>
    ...
    file_element.onchange = function() {
        ...
        if (!['image/jpeg', 'image/png'].includes(file_element.files[0].type)) {
            ...
            ajax_request.open("POST", "{{ url('student-store') }}");
