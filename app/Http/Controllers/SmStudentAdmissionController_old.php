...
class SmStudentAdmissionController extends Controller
{
    ...
    public function __construct()
    {
       ...
       //rajput $this->SmGeneralSettings    = json_encode(SmGeneralSettings::where('school_id',auth()->user()->school_id)->first());
    ...
    public function studentDetailsSearch(Request $request)
    {
        ...
        try {
           ...
           //rajput $students = $students->with(->class,'section','parents','section','gender','category')->where('school_id', Auth::user()->school_id)->get();
