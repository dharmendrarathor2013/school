...
Route::group(['middleware' => ['XSS','subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
		...
		// student log
		 ...
		 Route::get('student-log', ['uses' => 'UserController@studentLog']);
        ...
        Route::delete('question-bank/{id}', 'Admin\OnlineExam\SmQuestionBankController@destroy')->name('question-bank-delete')->middleware('userRolePermission:237');
         ...
         Route::get('import-question-bank', 'Admin\OnlineExam\SmQuestionBankController@import_question_bank')->middleware('userRolePermission:906');
         
         Route::get('download_questionbanks_file', ['as' => 'download_questionbanks_file', 'uses' => 'Admin\OnlineExam\SmQuestionBankController@downloadQuestionbankFile']);
        Route::post('qbank-bulk-store', ['as' => 'qbank_bulk_store', 'uses' => 'Admin\OnlineExam\SmQuestionBankController@bulkstore']);
       ...
       //staff import
       Route::get('import-staff', ['as' => 'import_staff', 'uses' => 'Admin\Hr\SmStaffController@importStaff'])->middleware('userRolePermission:4001');
       Route::get('download_staff_file', ['as' => 'download_staff_file', 'uses' => 'Admin\Hr\SmStaffController@downloadStaffFile']);
       Route::post('staff-bulk-store', ['as' => 'staff_bulk_store', 'uses' => 'Admin\Hr\SmStaffController@staffBulkStore']);
 ...
 Route::get('google-backup', 'Admin\StudentInfo\SmStudentAdmissionController@googleBackup');
		Route::get('google-backup-auth', 'Admin\StudentInfo\SmStudentAdmissionController@googleDriveAuth');
	...
	//color-style-list-update
    Route::post('color-style-list-update', 'Admin\Style\SmBackGroundSettingController@color_style_list_update');
