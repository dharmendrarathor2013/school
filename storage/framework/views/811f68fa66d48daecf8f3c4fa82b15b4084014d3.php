                ...
                <div class="<?php echo e($custom_field->width); ?> mt-30">
                    <div class="input-effect sm2_mb_20 md_mb_20">
                        <select class="niceSelect w-100 bb form-control<?php echo e($errors->has($custom_field->label) ? ' is-invalid' : ''); ?>" 
                            ...
                            <option data-display="<?php echo e($custom_field->label); ?> <?php echo app('translator')->get('common.select'); ?> <?php echo e(($custom_field->required==1)? "*":""); ?>" value=""><?php echo e($custom_field->label); ?> <?php echo app('translator')->get('common.select'); ?> <?php echo e(($custom_field->required==1)? "*":""); ?></option>
                    ...
                    <div class="row no-gutters input-right-icon">
                        ...
                        <div class="col-auto">
                            <button class="primary-btn-small-input" type="button">
                                <label class="primary-btn small fix-gr-bg" for="photo_<?php echo e($key); ?>"><?php echo app('translator')->get('common.browse'); ?></label>
...
<?php endif; ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/studentInformation/_custom_field.blade.php ENDPATH**/ ?>