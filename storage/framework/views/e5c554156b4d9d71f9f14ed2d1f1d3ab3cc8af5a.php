    ...
    <table cellspacing="0" width="100%">
        <tr>
            ...
            <td style="text-aligh:left"> 
                ...
                class="text-white"><?php echo app('translator')->get('common.class_Sec'); ?>: <?php echo e(@$class->class_name.'('.$section->section_name.')'); ?> </span>
                   ...
                   <?php if($classes[$i]['is_break']): ?>
                    ...
                    <?php else: ?>
                       ...
                       <?php if($classes[$i]['subject']): ?>
                        <span class="">  <strong>  <?php echo e($classes[$i]['subject']); ?> </strong>  <?php if($classes[$i]['class_room']): ?>
...
<?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/academics/class_routine_print.blade.php ENDPATH**/ ?>