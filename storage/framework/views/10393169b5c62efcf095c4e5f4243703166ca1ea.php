                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-30">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('front_settings.title'); ?> <span>*</span></label>
                                                ...
                                                <div class="col">
                                                    <div class="input-effect">
                                                        <input class="primary-input form-control<?php echo e($errors->has('image') ? ' is-invalid' : ''); ?>" type="text"
                                                                ...
                                                                placeholder="<?php echo e(isset($add_course)? ($add_course->image !="") ? getFilePath3($add_course->image) :trans('front_settings.image') .' *' :trans('front_settings.image') . '(' .trans('front_settings.min')." 1420*450 PX)"); ?>"
                                                                readonly
                                                        >
                                                        <span class="focus-border"></span>
                                ...
                                <div class="col-md-12 ">
                                    <div class="row mt-20">
                                        <div class="col-md-12 mt-20">
                                            <div class="input-effect">
                                                <label><?php echo app('translator')->get('front_settings.overview'); ?> </label>
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-md-12">
                                            <div class="input-effect">
                                                <label><?php echo app('translator')->get('front_settings.outline'); ?> <span></span></label>
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-md-12">
                                            <div class="input-effect">
                                                <label><?php echo app('translator')->get('front_settings.prerequisites'); ?> <span></span></label>
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-md-12">
                                            <div class="input-effect">
                                                <label><?php echo app('translator')->get('front_settings.resources'); ?> <span></span></label>
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-md-12">
                                            <div class="input-effect">
                                                <label><?php echo app('translator')->get('front_settings.stats'); ?> <span></span></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/frontSettings/course/course_page.blade.php ENDPATH**/ ?>