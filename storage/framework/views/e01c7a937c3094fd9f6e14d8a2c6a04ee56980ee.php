...
<div class="card-body">
    ...
    <a href="<?php echo e(route('service.database')); ?>" class="offset-3 col-sm-6 primary-btn fix-gr-bg  mb-20">
...
<?php echo $__env->make('service::layouts.app_install', ['title' => __('service::install.environment')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources//views/vendors/service/install/preRequisite.blade.php ENDPATH**/ ?>