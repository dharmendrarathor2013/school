        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <ul class="nav nav-tabs tab_column" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('twilio_settings') == 'active'): ?> active <?php endif; ?> " href="#twilio_settings" role="tab" data-toggle="tab"><?php echo app('translator')->get('system_settings.twilio'); ?> </a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('msg91_settings') == 'active'): ?> active <?php endif; ?> " href="#msg91_settings" role="tab" data-toggle="tab"><?php echo app('translator')->get('system_settings.msg91'); ?> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('textlocal_settings') == 'active'): ?> active <?php endif; ?> " href="#textlocal_settings" role="tab" data-toggle="tab"><?php echo app('translator')->get('system_settings.textlocal'); ?> </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('africatalking_settings') == 'active'): ?> active <?php endif; ?> " href="#africatalking_settings" role="tab" data-toggle="tab"><?php echo app('translator')->get('system_settings.africatalking'); ?> </a>
                    </li>  
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(Session::get('Mobile_SMS') == 'active'): ?> active <?php endif; ?> " href="#Mobile_SMS" role="tab" data-toggle="tab"><?php echo app('translator')->get('system_settings.mobile_sms'); ?></a>
                    </li> 
                </ul>
                <!-- Tab panes -->
                                ...
                                <div class="col-lg-4 select_sms_services">
                                    <div class="input-effect">
                                        <select class="niceSelect w-100 bb form-control<?php echo e($errors->has('book_category_id') ? ' is-invalid' : ''); ?>" name="sms_service" id="sms_service">
                                            <option data-display="<?php echo app('translator')->get('system_settings.select_a_SMS_service'); ?>" value=""><?php echo app('translator')->get('system_settings.select_a_SMS_service'); ?></option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.twilio_account_sid'); ?> <span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.authentication_token'); ?> <span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.registered_phone_number'); ?> <span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            ...
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.authentication_key_sid'); ?> <span>*</span> </label> 
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.sender_id'); ?> <span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('common.route'); ?> <span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.country_code'); ?> <span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.textlocal_username'); ?><span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.textlocal_hash'); ?> <span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.textlocal_sender'); ?><span>*</span> </label>
                                                <span class="focus-border"></span>
                    ...
                    <div class="row mb-30">
                        ...
                        <?php if($sms_services['Mobile SMS']->device_info): ?>
                            ...
                            <li>
                                ...
                                <?php else: ?>
                                    <button class="primary-btn small bg-success text-white border-0  tr-bg"><?php echo app('translator')->get('common.online'); ?></button>
                                <?php endif; ?>
                            </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.api_key'); ?> <span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.route_id'); ?><span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-lg-6 mb-30">
                                                <div class="input-effect">
                                                    ...
                                                    <label> <?php echo app('translator')->get('system_settings.campaign_id'); ?><span>*</span> </label>
                                                    <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.africatalking_username'); ?><span>*</span> </label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('system_settings.africatalking_api_key'); ?> <span>*</span> </label>
                                                <span class="focus-border"></span>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\InfixEduv6.6.1\resources\views/backEnd/systemSettings/smsSettings.blade.php ENDPATH**/ ?>