                    ...
                    <div class="col-lg-12">
                        <div class="white-box mt-10">
                            <div class="row">
                                 <div class="col-lg-10">
                                    <div class="main-title">
                                        <h5><?php echo app('translator')->get('lesson::lesson.add_lesson_name'); ?></h5>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                        ...
                                        <td class="">
                                            ...
                                            <div class="input-effect">
                                                <input class="primary-input form-control<?php echo e($errors->has('topic') ? ' is-invalid' : ''); ?>"
                                                    ...
                                                    <label><?php echo app('translator')->get('lesson::lesson.title'); ?></label>
                                            </div>
                                        </td>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/Modules/Lesson/Resources/views/lesson/add_new_lesson.blade.php ENDPATH**/ ?>