                ...
                <div class="row">
                    <div class="col-lg-6 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->get('reports.user_log_report'); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    foreach ($user_logs as $row) { ?>
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                ...
                                                <a class="dropdown-item" data-toggle="modal" data-target="#deletebackground_settingModal<?php echo e($row->id); ?>" href="<?php echo e($row->id); ?>"> <span class="ti-eye" id=""></span></a>
                                            ...
                                            <!-- open modal -->
                                            <div class="modal fade admin-query" id="deletebackground_settingModal<?php echo e($row->id); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/reports/report.blade.php ENDPATH**/ ?>