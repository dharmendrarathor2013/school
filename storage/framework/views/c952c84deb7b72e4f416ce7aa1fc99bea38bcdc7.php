                    ...
                    <div class="">
                        ...
                        <div class="row mb-20">
                            ...
                            <?php if(generalSetting()->multiple_roll==0): ?>
                                <div class="col-lg-2">
                                    <div class="input-effect">
                                        <input class="primary-input read-only-input" type="text" name="roll_number" value="<?php echo e($student->roll_no); ?>" id="roll_number">
                                        <label><?php echo e(moduleStatusCheck('Lead') ? __('student.id_number') : __('student.roll')); ?><?php if(is_required('roll_number')==true): ?> <span> *</span> <?php endif; ?></label>
                                        <span class="focus-border"></span>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="col-lg-3">
							 ...
							 <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input form-control<?php echo e($errors->has('rfid_no') ? ' is-invalid' : ''); ?>" type="text" name="rfid_no" value="<?php echo e($student->rfid_no); ?>">
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input" type="text" id="placeholderFathersName" placeholder="<?php echo e(@$student->parents->fathers_photo ? getFilePath3(@$student->parents->fathers_photo):(is_required('fathers_photo')==true ? __('common.photo') .'*': __('common.photo'))); ?>"
                                                    disabled>
                                                <span class="focus-border"></span>
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input" type="text" id="placeholderMothersName" placeholder="<?php echo e(@$student->parents->mothers_photo ? getFilePath3(@$student->parents->mothers_photo):(is_required('mothers_photo')==true ? __('common.photo') .'*': __('common.photo'))); ?>"
                                                    disabled>
                                                <span class="focus-border"></span>
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-20">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input" type="text" id="placeholderGuardiansName" placeholder="<?php echo e(@$student->parents->guardians_photo ? getFilePath3(@$student->parents->guardians_photo):(is_required('guardians_photo')==true ? __('common.photo') .'*': __('common.photo'))); ?>"
                                                    disabled>
                                                <span class="focus-border"></span>
                                            </div>
                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/studentInformation/student_edit.blade.php ENDPATH**/ ?>