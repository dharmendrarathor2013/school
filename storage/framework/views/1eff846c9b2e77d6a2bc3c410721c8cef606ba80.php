                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    <div class="row mb-25" style="margin-bottom: -12px;">
                                        <div class="col-lg-12 mb-30">
                                            <div class="input-effect">
                                                ...
                                                <label> <?php echo app('translator')->get('study.content_title'); ?> <span>*</span> </label>
                                        ...
                                        <div class="col-lg-12 mb-30">
                                            <label><?php echo app('translator')->get('study.available_for'); ?>*</label><br>
                                            <div class="">
                                                ...
                                                <div class="col-lg-12 mb-20">
												  ...
												  <div class="col-lg-12 mb-30">
                                                    <?php if(!isset($editData->section)): ?>        
                                                        <div class="input-effect" id="selectSectionsDiv">
                                                            <label for="checkbox" class="mb-2"><?php echo app('translator')->get('common.section'); ?> *</label>
                                                            <select multiple id="selectSectionss" name="section[]" style="">
                                    ...
                                    <div class="row mb-20">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('study.description'); ?> <span></span> </label>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a data-modal-size="modal-lg" title="<?php echo e(__('study.view_content_details')); ?>" class="dropdown-item modalLink" href="<?php echo e(route('upload-content-view', $value->id)); ?>"><?php echo app('translator')->get('common.view'); ?></a>
                                                        
                                                        <?php if(moduleStatusCheck('VideoWatch')== TRUE): ?>
                                                            <a class="dropdown-item" href="<?php echo e(url('videowatch/view-log/'.$value->id)); ?>"><?php echo app('translator')->get('study.seen'); ?></a>
                                                        <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/teacher/uploadContentList.blade.php ENDPATH**/ ?>