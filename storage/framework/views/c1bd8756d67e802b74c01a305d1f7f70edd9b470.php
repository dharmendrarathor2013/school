            ...
            <div class="row">
                <div class="col-lg-2">
				   ...
				   <div class="offset-lg-2 col-lg-2 text-right mb-20">
                    <a href="<?php echo e(url('staff-directory')); ?>">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/humanResource/importStaff.blade.php ENDPATH**/ ?>