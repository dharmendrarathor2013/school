        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-4 no-gutters">
                    <div class="main-title">
                        <h3 class="mb-0"><?php echo app('translator')->get('homework.homework_list'); ?></h3>
                    </div>
                </div>
            </div>
            <div class="row">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                         ...
                                         <?php endif; ?>
                                          <?php if(userPermission(282)): ?>
                                           <a class="dropdown-item" href="<?php echo e(route('homework_edit', [$value->id])); ?>"><?php echo app('translator')->get('common.edit'); ?></a>
                                           <?php endif; ?>
                                            <?php if(userPermission(283)): ?>
                                            <a onclick="GlobaldeleteId();" class="dropdown-item"  data-url="<?php echo e(route('homework_delete',$value->id)); ?>"  href="#"><?php echo app('translator')->get('common.delete'); ?></a>
                                        <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/homework/homeworkList.blade.php ENDPATH**/ ?>