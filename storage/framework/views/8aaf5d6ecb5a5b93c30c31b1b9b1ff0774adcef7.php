       ...
       <div class="row">
                                ...
                                <div class="row">                                 
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        <div class="input-effect">
                                            ...
                                            <label> <?php echo app('translator')->get('inventory.store_name'); ?> <span>*</span> </label>
                                     ...
                                     <div class="col-lg-12 mb-20">
                                        <div class="input-effect">
                                            ...
                                            <label> <?php echo app('translator')->get('inventory.number'); ?> *</label>
                                            <span class="focus-border"></span>
          ...
          <div class="row">
            <div class="col-lg-4 no-gutters">
                <div class="main-title">
                    <h3 class="mb-0"><?php echo app('translator')->get('inventory.item_store_list'); ?></h3>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/inventory/itemStoreList.blade.php ENDPATH**/ ?>