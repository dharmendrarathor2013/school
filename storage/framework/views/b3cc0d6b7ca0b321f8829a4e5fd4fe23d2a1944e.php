                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <div class="primary_input mb-25">
                                                                <label class="primary_input_label" for=""><?php echo app('translator')->get('chat::chat.username'); ?> <span class="text-danger">*</span></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/impact-eschool-erp-main/Modules/Chat/Resources/views/user/blocked.blade.php ENDPATH**/ ?>