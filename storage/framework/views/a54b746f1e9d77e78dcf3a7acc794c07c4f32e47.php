                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-20">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('student.category_name'); ?> <span>*</span> </label>
                                        ...
                                        <div class="text-center mt-10">
                                            <code><?php echo app('translator')->get('front_settings.min'); ?> (1420*450 px)</code>
                                        </div>
                                    <?php
                                        $tooltip = "";
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"> <?php echo app('translator')->get('front_settings.course_category_list'); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <?php if(userPermission(675)): ?>
                                                            <a class="dropdown-item" href="<?php echo e(route('edit-course-category',$value->id)); ?>"> <?php echo app('translator')->get('common.edit'); ?></a>
                                                        <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/course/course_category.blade.php ENDPATH**/ ?>