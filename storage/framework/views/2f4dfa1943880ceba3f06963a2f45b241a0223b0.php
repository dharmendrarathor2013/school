        ...
        <div class="row">
         <div class="col-lg-3 mb-30">
            ...
            <div class="main-title">
                <h3 class="mb-20"><?php echo app('translator')->get('hr.staff_details'); ?></h3>
            </div>
...
<div class="col-lg-9 staff-details">
    <ul class="nav nav-tabs tabs_scroll_nav" role="tablist">
        <li class="nav-item">
            <a class="nav-link <?php if(Session::get('staffDocuments') != 'active' && Session::get('staffTimeline') != 'active'): ?> active <?php endif; ?>" href="#studentProfile" role="tab" data-toggle="tab"><?php echo app('translator')->get('hr.profile'); ?></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link <?php echo e(Session::get('staffDocuments') == 'active'? 'active':''); ?>" href="#staffDocuments" role="tab" data-toggle="tab"><?php echo app('translator')->get('hr.documents'); ?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?php echo e(Session::get('staffTimeline') == 'active'? 'active':''); ?>" href="#staffTimeline" role="tab" data-toggle="tab"><?php echo app('translator')->get('hr.timeline'); ?></a>
        </li>
    ...
    <div class="white-box">
        ...
        <thead>
            <tr>
                ...
                <th width="15%"><?php echo app('translator')->get('hr.net_salary'); ?>(<?php echo e(generalSetting()->currency_symbol); ?>)</th>
...
<?php echo e($value->created_at != ""? dateConvert($value->created_at):''); ?>
                ...
                <td>
                    <?php if($value->payroll_status == 'P'): ?>
                    <a class="modalLink" data-modal-size="modal-lg" title="<?php echo app('translator')->get('hr.view_payslip_details'); ?>" href="<?php echo e(route('view-payslip', $value->id)); ?>"><button class="primary-btn small tr-bg"> <?php echo app('translator')->get('common.view_payslip'); ?></button></a>
                    <?php endif; ?>
                </td>
            </tr>
            ...
            <tr class="justify-content-center">
                <td colspan="7" class="justify-content-center text-center"><?php echo app('translator')->get('hr.no_payroll_data'); ?></td>
            </tr>
            <?php endif; ?>
        </tbody>
    </table>
...
<?php echo e($value->apply_date != ""? dateConvert($value->apply_date):''); ?>
                        ...
                        <td>
                            ...
                            <button class="primary-btn small bg-danger text-white border-0"> <?php echo app('translator')->get('hr.cancelled'); ?></button>
                            <?php endif; ?>
            ...
            <tbody class="d-block">
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-5 d-flex align-itemd-center">
                        ...
                        <a class="primary-btn icon-only fix-gr-bg modalLink ml-2" title="<?php echo e(__('hr.delete_document')); ?>" data-modal-size="modal-md"  href="<?php echo e(route('delete-staff-document-view',$value->student_staff_id)); ?>">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('hr.title'); ?> <span>*</span> </label>
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input" id="placeholderInput" type="text"
                                                       placeholder="<?php echo app('translator')->get('hr.new_document'); ?>*"
                                                       readonly>
                                                <span class="focus-border"></span>
                                            </div>
                                        </div>
                        ...
                        <div class="single-activity">
                            ...
                            <div class="sub-activity-box d-flex">
                                ...
                                <div class="close-activity">
                                    <a class="primary-btn icon-only fix-gr-bg modalLink" title="<?php echo e(__('hr.delete_timeline')); ?>" data-modal-size="modal-md"  href="<?php echo e(route('delete-staff-timeline-view',$timeline->id)); ?>">
                                        <span class="ti-trash"></span>
                                    </a>
                       ...
                       <div class="container-fluid">
                             ...
                             <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input" id="placeholderFileFourName" type="text"
                                                       placeholder="<?php echo app('translator')->get('hr.document'); ?>"
                                                       readonly>
                                                <span class="focus-border"></span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12 mt-30">
                                    ...
                                    <label for="currentAddressCheck"><?php echo app('translator')->get('hr.visible_to_this_person'); ?></label>
                                </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/humanResource/viewStaff.blade.php ENDPATH**/ ?>