...
<?php $__env->startPush('script'); ?>
    <script type="text/javascript"
            src="<?php echo e(asset('public/vendor/spondonit/js/parsley.min.js')); ?>"></script>
    <script type="text/javascript"
            src="<?php echo e(asset('public/vendor/spondonit/js/function.js')); ?>"></script>
    <script type="text/javascript"
            src="<?php echo e(asset('public/vendor/spondonit/js/common.js')); ?>"></script>
    <?php $__env->stopPush(); ?>
    ...
    <section class="admin-visitor-area">
                    ...
                    <div class="row">
                        <div class="col-lg-10 col-xs-6 col-md-6 col-6 no-gutters ">
                            <div class="main-title sm_mb_20 sm2_mb_20 md_mb_20 mb-30 ">
                                <h3 class="mb-0"> <?php echo app('translator')->get('system_settings.module_manage'); ?></h3>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <a href="#" data-toggle="modal" class="primary-btn small fix-gr-bg"
                                       data-target="#add_to_do" title="Add To Do" data-modal-size="modal-md">
                                        ...
                                        <?php echo app('translator')->get('common.add_module'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body text-left">
                                                                                    <?php echo Form::open(['class' => 'form-horizontal', 'id' => 'content_form_'.$count, 'route' => 'ManageAddOnsValidation', 'method' => 'POST']); ?>
                                                                                    ...
                                                                                    <div class="row mt-40">
                                                                                        <div class="col-lg-12 text-center">
                                                                                            <button class="primary-btn fix-gr-bg" type="submit">
                                                                                                <span class="ti-check"></span> <?php echo app('translator')->get('common.verify'); ?>
                                                                                            </button>
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                <?php else: ?>
                                                    <div id="waiting_loader" class="waiting_loader<?php echo e($module->name); ?>">
                                                    ...
                                                    <?php if(! Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                                                        <label class="switch module_switch_label<?php echo e($module->name); ?>">
                                                            <input type="checkbox" data-id="<?php echo e($module->name); ?>"
                                                                   ...
                                                                   class="switch-input1 module_switch" <?php echo e(moduleStatusCheck($module->name) == false? '':'checked'); ?>>
                                                    ...
                                                    <?php if( Illuminate\Support\Facades\Config::get('app.app_sync')): ?>
                                                        <label class="switch module_switch_demo">
                                                            <input type="checkbox" onClick="module_switch_demo()"
                                                                   class="switch-input1 module_switch_demo" <?php echo e(moduleStatusCheck($module->name) == false? '':'checked'); ?>>
                                                            <span class="slider round"></span>
                                                        </label>
                                                    <?php endif; ?>
                                                <?php endif; ?>
        ...
        <div class="modal fade admin-query" id="add_to_do">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><?php echo app('translator')->get('common.add_new_module'); ?></h4>
                                ...
                                <div class="col-lg-12">
                                    <div class="row no-gutters input-right-icon mb-20">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input form-control <?php echo e($errors->has('module_file') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <div class="col-lg-12 text-center">
                                        <div class="mt-40 d-flex justify-content-between">
                                            ...
                                            <input class="primary-btn fix-gr-bg submit" type="submit" value="<?php echo app('translator')->get('common.submit'); ?>">
                                        </div>
                                    </div>
                                </div>
                                <?php echo e(Form::close()); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/impact-eschool-erp-main/resources/views/backEnd/systemSettings/ManageAddOns.blade.php ENDPATH**/ ?>