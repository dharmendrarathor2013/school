                ...
                <div class="white-box">
                    <div class="">
                        ...
                        <div class="row mb-40 mt-30">
                            ...
                            <div class="col-lg-2">
                                <div class="input-effect">
                                    <input class="primary-input  form-control<?php echo e($errors->has('admission_number') ? ' is-invalid' : ''); ?>" type="text" onkeyup="GetAdmin(this.value)" name="admission_number" value="<?php echo e($max_admission_id != ''? $max_admission_id + 1 : 1); ?>">
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-3">
                                <div class="input-effect sm2_mb_20 md_mb_20">
                                    <input class="primary-input form-control<?php echo e($errors->has('rfid_no') ? ' is-invalid' : ''); ?>" type="text" name="rfid_no" value="<?php echo e(old('rfid_no')); ?>">
                                    <label>RFID No <?php if(is_required('rfid_no')==true): ?> <span> *</span> <?php endif; ?> </label>
                                    <span class="focus-border"></span>
                                    <?php if($errors->has('rfid_no')): ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('rfid_no')); ?></strong>
                                    </span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-2">
                                <div class="no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input date" id="" type="text" name="admission_date" value="<?php echo e(old('admission_date') != ""? old('admission_date'):date('m/d/Y')); ?>" autocomplete="off">
                        ...
                        <div class="row mb-40">
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderPhoto" placeholder="<?php echo app('translator')->get('common.student_photo'); ?>  <?php if(is_required('photo')==true): ?> * <?php endif; ?>" readonly="">
                                            <span class="focus-border"></span>
                            ...
                            <div class="row mb-40 mt-30">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input" type="text" id="placeholderFathersName" placeholder="<?php echo app('translator')->get('common.photo'); ?> <?php if(is_required('fathers_photo')==true): ?> * <?php endif; ?>" readonly="">
                                                <span class="focus-border"></span>
                            ...
                            <div class="row mb-30">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input" type="text" id="placeholderMothersName" placeholder="<?php echo app('translator')->get('student.photo'); ?>  <?php if(is_required('mothers_photo')==true): ?> * <?php endif; ?>" readonly="">
                                                <span class="focus-border"></span>
                            ...
                            <div class="row mb-40">
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input" type="text" id="placeholderGuardiansName" placeholder="<?php echo app('translator')->get('student.photo'); ?> <?php if(is_required('guardians_photo')==true): ?> * <?php endif; ?>" readonly="">
                                                <span class="focus-border"></span>
                        ...
                        <div class="row mb-30">
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderFileOneName" placeholder="01  <?php if(is_required('document_file_1')==true): ?> * <?php endif; ?>" readonly="">
                                            <span class="focus-border"></span>
                                    ...
                                    <!-- progress -->
                                    <div id="progress_bar" style="display:none;height:50px; line-height: 50px;">

                                    <div class="progress-bar" id="progress_bar_process" role="progressbar" style="width:0%;height:30%;  border-radius: 25px;">0%</div>
                            ...
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderFileTwoName" placeholder="02 <?php if(is_required('document_file_2')==true): ?> * <?php endif; ?>" readonly="">
                                            <span class="focus-border"></span>
                            ...
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderFileThreeName" placeholder="03 <?php if(is_required('document_file_3')==true): ?> * <?php endif; ?>" readonly="">
                                            <span class="focus-border"></span>
                            ...
                            <div class="col-lg-3">
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" id="placeholderFileFourName" placeholder="04 <?php if(is_required('document_file_4')==true): ?> * <?php endif; ?>" readonly="">
                                            <span class="focus-border"></span>
...
<script>
    // start progress
    var file_element = document.getElementById('document_file_1');
    ...
    file_element.onchange = function() {
        ...
        if (!['image/jpeg', 'image/png'].includes(file_element.files[0].type)) {
            ...
            ajax_request.open("POST", "<?php echo e(url('student-store')); ?>");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/studentInformation/student_admission.blade.php ENDPATH**/ ?>