                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label><?php echo app('translator')->get('common.select_exam_type'); ?> *</label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('exam.exam_mark'); ?> *</label>
                                    ...
                                    <tr id="row1" class="mt-40">
                                        <td class="border-top-0">
                                            ...
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('exam.title'); ?></label>
                                            </div>
                                        </td>
                                        <td class="border-top-0">
                                            <div class="input-effect">
                                            ...
                                            <div class="row mt-40">
                                                <div class="col-lg-12 text-center">
                                                  <button class="primary-btn fix-gr-bg submit" data-toggle="tooltip" title="<?php echo e(@$tooltip); ?>">
                                                        ...
                                                        <?php if(isset($exam)): ?>
                                                            <?php echo app('translator')->get('exam.update_marks'); ?>
                                                        <?php else: ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/examination/exam.blade.php ENDPATH**/ ?>