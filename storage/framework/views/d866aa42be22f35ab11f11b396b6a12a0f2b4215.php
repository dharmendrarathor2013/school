            ...
            <div class="row align-items-center">
                <div class="col-lg-8 col-md-6 col-6">
                    <div class="main-title">
                        <h3 class="mb-30"><?php echo app('translator')->get('admin.select_criteria'); ?></h3>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    ...
                                    <label><?php echo app('translator')->get('admin.date_from'); ?> *</label>
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    ...
                                    <label><?php echo app('translator')->get('admin.date_to'); ?> *</label>
                                    <span class="focus-border"></span>
                            ...
                            <div class="col-lg-3">
                                <div class="input-effect">
                                    <select class="niceSelect w-100 bb form-control <?php echo e($errors->has('select_status') ? ' is-invalid' : ''); ?>"
                                        ...
                                        <option value="1" <?php echo e(isset($status_id)? ($status_id ==  '1'? 'selected':''):''); ?>><?php echo app('translator')->get('admin.active'); ?></option>
                                        <option value="2" <?php echo e(isset($status_id)? ($status_id == '2'? 'selected':''):''); ?>><?php echo app('translator')->get('admin.inactive'); ?></option>
                                    </select>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"><?php echo app('translator')->get('admin.query_list'); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $admission_queries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$admission_query): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <?php if(userPermission(13)): ?>
                                                        <a class="dropdown-item"
                                                           href="<?php echo e(route('add_query', [@$admission_query->id])); ?>"><?php echo app('translator')->get('admin.add_query'); ?></a>
                                                    <?php endif; ?>
                                                    <?php if(userPermission(14)): ?>
                                                        <a class="dropdown-item modalLink" data-modal-size="large-modal"
                                                           title="<?php echo app('translator')->get('admin.edit_admission_query'); ?>"
                                                           href="<?php echo e(route('admission_query_edit', [@$admission_query->id])); ?>"><?php echo app('translator')->get('common.edit'); ?></a>
                                                    <?php endif; ?>
                                                    <?php if(userPermission(15)): ?>
                                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                                           data-target="#deleteAdmissionQueryModal<?php echo e(@$admission_query->id); ?>"><?php echo app('translator')->get('common.delete'); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        ...
                                                        <button class="primary-btn fix-gr-bg"
                                                                type="submit"><?php echo app('translator')->get('admin.delete'); ?></button>
                                                        <?php echo e(Form::close()); ?>
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-effect">
                                                <input class="primary-input read-only-input form-control" type="text"
                                                       name="name" id="name">
                                                <label><?php echo app('translator')->get('admin.name'); ?><span>*</span></label>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-effect">
                                                <input oninput="emailCheck(this)" class="primary-input read-only-input form-control" type="email"
                                                       name="email">
                                                <label><?php echo app('translator')->get('admin.email'); ?><span></span></label>
                                                <span class="focus-border"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('admin.address'); ?><span></span> </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="input-effect">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="input-effect">
                                                        <input class="primary-input date form-control" id="endDate"
                                                               ...
                                                               readonly="true" value="<?php echo e(date('m/d/Y', strtotime(' + 1 days'))); ?>" required>
                                                        <label><?php echo app('translator')->get('admin.next_follow_up_date'); ?> *</label>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('admin.assigned'); ?> *<span></span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <select class="niceSelect w-100 bb" name="source" id="source">
                                                <option data-display="<?php echo app('translator')->get('admin.source'); ?> *" value=""><?php echo app('translator')->get('admin.source'); ?>*</option>
                                                <?php $__currentLoopData = $sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('admin.number_of_child'); ?> *<span></span></label>
                                                <span class="focus-border"></span>
                                ...
                                <div class="col-lg-12 text-center mt-40">
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        <button class="primary-btn fix-gr-bg submit" id="save_button_query" type="submit"><?php echo app('translator')->get('admin.save'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/admin/admission_query.blade.php ENDPATH**/ ?>