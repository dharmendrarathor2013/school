...
<div class="role_permission_wrap">
    ...
    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'rolepermission/role-permission-assign',
                        'method' => 'POST'])); ?>
                    ...
                    <div class="single_permission" id="<?php echo e($module_info->id); ?>">
                        ...
                        <div class="permission_header d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                ...
                                <label for="Main_Module_<?php echo e($module_info->id); ?>"><?php echo e(__('rolepermission::permissions.'.$module_info->name)); ?></label>
                            </div>
                        ...
                        ?>
                            ...
                            <li>
                                <div class="submodule">
                                    ...
                                    <label for="Sub_Module_<?php echo e($row2->id); ?>"><?php echo e(__('rolepermission::permissions.'.$row2->name)); ?> </label>
                                    <br>
                                </div>
                                ...
                                <?php $__currentLoopData = $childModule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <li>
                                      <div class="module_link_option_div" id="<?php echo e($row2->id); ?>">
                                          ...
                                          <label for="Option_<?php echo e($row3->id); ?>"><?php echo e(__('rolepermission::permissions.'.$row3->name)); ?> </label>
                                          <br>
                                      </div>
                                  </li>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/Modules/RolePermission/Resources/views/role_permission_student.blade.php ENDPATH**/ ?>