                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                            <div class="mr-20">
                                                                                                <input type="radio" name="preloader_status" id="preloader_status_enable" value="1" class="common-radio" <?php if(generalSetting()->preloader_status == 1): ?> checked <?php endif; ?>>
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <div class="mr-20">
                                                                                            <input type="radio" name="preloader_status" id="preloader_status_disable" value="0" class="common-radio " <?php if(generalSetting()->preloader_status == 0): ?> checked
                                                                                                    <?php endif; ?>>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <div class="mr-20">
                                                                                            <input type="radio" name="preloader_type" id="preloader_type_animation" value="1" class="common-radio" <?php if(!generalSetting()->preloader_type || generalSetting()->preloader_type == 1): ?> checked <?php endif; ?>>
                                                                                    ...
                                                                                    <div class="col-md-3 mb-25">
                                                                                        <div class="mr-20">
                                                                                            <input type="radio" name="preloader_type" id="preloader_type_image" value="2" class="common-radio " <?php if(generalSetting()->preloader_type == 2): ?> checked <?php endif; ?>>
                                                                                ...
                                                                                <div class="row no-gutters input-right-icon">
                                                                                    <div class="col">
                                                                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                                                                            <input class="primary-input filePlaceholder" type="text" id="placeholderPhoto" placeholder="<?php echo app('translator')->get('system_settings.Preloader Image'); ?>"
                                                                                                   readonly="">
                                                                                    ...
                                                                                    <div class="col-auto">
                                                                                        <button class="primary-btn-small-input" type="button">
                                                                                            <label class="primary-btn small fix-gr-bg" for="file1"><?php echo app('translator')->get('common.browse'); ?></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/systemSettings/preloader.blade.php ENDPATH**/ ?>