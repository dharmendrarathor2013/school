                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="white-box">
                                <div class="add-visitor">
                                    ...
                                    <div class="row mt-30">
                                        <div class="col-lg-12">
                                            <label><?php echo app('translator')->get('common.section'); ?>*</label><br>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <?php if(userPermission(263)): ?>
                                                        <a class="dropdown-item"
                                                           href="<?php echo e(route('class_edit', [@$class->id])); ?>"><?php echo app('translator')->get('common.edit'); ?></a>
                                                    <?php endif; ?>
                                                    <?php if(userPermission(264)): ?>
                                                        <a class="dropdown-item" data-toggle="modal"
                                                           data-target="#deleteClassModal<?php echo e(@$class->id); ?>"
                                                           href="<?php echo e(route('class_delete', [@$class->id])); ?>"><?php echo app('translator')->get('common.delete'); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/academics/class.blade.php ENDPATH**/ ?>