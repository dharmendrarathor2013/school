                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('accounts.bank_name'); ?> <span>*</span></label>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('accounts.account_name'); ?> <span>*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('accounts.account_number'); ?> <span>*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('accounts.account_type'); ?></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row  mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('accounts.opening_balance'); ?><span>*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-40">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('common.note'); ?> <span></span></label>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->get('accounts.bank_account_list'); ?></h3>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format(@$bank_account->opening_balance, 2)); ?></td>
                                    <td><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format(@$bank_account->current_balance, 2)); ?></td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                               <!-- <?php if(userPermission(158)): ?>
                                                <a class="dropdown-item" href="<?php echo e(route('bank-account-edit', [$bank_account->id])); ?>"><?php echo app('translator')->get('common.edit'); ?></a>
                                                <?php endif; ?> -->
                                                <?php if(userPermission(158)): ?>
                                                    <a class="dropdown-item" href="<?php echo e(route('bank-transaction',[$bank_account->id])); ?>"><?php echo app('translator')->get('accounts.transaction'); ?></a>
                                                <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/accounts/bank_account.blade.php ENDPATH**/ ?>