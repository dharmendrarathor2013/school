                                                ...
                                                <thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label class="switch">
                                                                    <input type="checkbox" data-id="<?php echo e($field->id); ?>" class="staff_switch_btn"
                                                            ...
                                                            <td>
                                                                <label class="switch">
                                                                    <input type="checkbox" <?php if($field->field_name == 'phone_number'): ?>
                                                                    id='phone_number' data-phone_number="<?php echo e($field->is_required); ?>"
                                                                        <?php endif; ?> <?php if($field->field_name == 'email_address'): ?> id='email_address' data-email_address="<?php echo e($field->is_required); ?>"  <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/humanResource/staff_settings.blade.php ENDPATH**/ ?>