            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="main-title">
                        <h3 class="mb-20"><?php echo app('translator')->get('parent.my_children'); ?></h3>
                    </div>
                </div>
            </div>
            ...
            <?php if(userPermission(65)): ?>
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="main-title">
                                <h3 class="mb-30"><?php echo app('translator')->get('parent.calendar'); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/parentPanel/parent_dashboard.blade.php ENDPATH**/ ?>