    ...
    <div class="container-fluid p-0">
		  ...
		  <div class="row">
            ...
            <div class="offset-lg-2 col-lg-2 text-right mb-20">
                <a href="<?php echo e(url('student-list')); ?>">
                    <button class="primary-btn tr-bg text-uppercase bord-rad">
                        <?php echo app('translator')->get('student.student_lists'); ?>
                    </button>
                </a>
            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="main-title">
                                    <div class="box-body">      
                                        ...
                                        5. Please follow this date format(2020-06-15) for Date of birth & Admission date<br>
                                        <hr>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/studentInformation/import_student.blade.php ENDPATH**/ ?>