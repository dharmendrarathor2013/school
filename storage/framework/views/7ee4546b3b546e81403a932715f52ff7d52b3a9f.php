    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('parent_subjects', [$student_detail->id])); ?>"><?php echo app('translator')->get('student.teacher_list'); ?></a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/parentPanel/teacher_list.blade.php ENDPATH**/ ?>