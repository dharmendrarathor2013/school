...
$primary_color3 = $activeStyle['primary_color3'];
...
<style>
 ...
 .nav-buttons .nav-item a:hover {
    ...
    background-color:<?php echo $primary_color3; ?>;
    color: #ffffff;
} 
...
.admin .navbar .right-navbar .dropdown .primary-btn {
    background:<?php echo $primary_color3; ?>;
}
                    ...
                    <div class="collapse navbar-collapse flex-end" id="navbarSupportedContent">
                        <ul class="nav navbar-nav mr-auto nav-buttons flex-sm-row">
                            <?php if( generalSetting()->website_btn==1): ?>
                                <li class="nav-item">
                                    <a class="primary-btn mr-10" href="<?php echo e(url('/')); ?>/home"><?php echo app('translator')->get('common.website'); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(generalSetting()->dashboard_btn==1): ?>
                                <?php if(Auth::user()->role_id == $coltroller_role): ?>
                                    <li class="nav-item">
                                        <a class="primary-btn mr-10"
                            ...
                            <?php if( generalSetting()->report_btn==1): ?>
                                <?php if(Auth::user()->role_id == $coltroller_role): ?>
                                    <li class="nav-item">
                                        <a class="primary-btn" href="<?php echo e(route('student_report')); ?>"><?php echo app('translator')->get('reports.reports'); ?></a>
                                    </li>
                                <?php endif; ?>
                            <?php endif; ?>
...
<?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/partials/menu.blade.php ENDPATH**/ ?>