                        ...
                        <div class="col-lg-12">
                            ...
                            <?php else: ?>
                                <?php if(userPermission(42)): ?>
                                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'setup-admin', 'method' => 'POST'])); ?>
                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <select
                                                class="niceSelect w-100 bb form-control<?php echo e($errors->has('type') ? ' is-invalid' : ''); ?>"
                                                name="type">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/admin/setup_admin.blade.php ENDPATH**/ ?>