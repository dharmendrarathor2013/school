                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <span style="font-size: 17px; padding-right: 15px;"><?php echo app('translator')->get('system_settings.style'); ?>  </span>
                            ...
                            <div class="row mt-20">
                                <div class="col-lg-4">
                                    <div class="d-flex align-items-center justify-content-left">
                                        ...
                                        <span style="font-size: 17px; padding-right: 15px;"><?php echo app('translator')->get('reports.report'); ?>   </span>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/systemSettings/buttonDisableEnable.blade.php ENDPATH**/ ?>