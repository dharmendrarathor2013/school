                        ...
                        <div class="col-lg-12">
                            ...
                            <?php else: ?>
                                <?php if(userPermission(28) || Auth::user()->role_id == 1): ?>
                                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'postal-receive', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                                    ...
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('admin.from_title'); ?><span>*</span></label>
                                    ...
                                    <div class="row mt-35">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('admin.reference'); ?> <?php echo app('translator')->get('admin.no'); ?> *</label>
                                                <span class="focus-border"></span>
                                    ...
                                    <div class="row mt-35">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('admin.address'); ?> *</label>
                                                <span class="focus-border"></span>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <label><?php echo app('translator')->get('admin.note'); ?><span></span></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-35">
                                            ...
                                            <div class="col-auto">
                                                <button class="primary-btn-small-input" type="button">
                                                    <label class="primary-btn small fix-gr-bg"
                                                        for="browseFile"><?php echo app('translator')->get('admin.browse'); ?></label>
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-lg-4 no-gutters">
                                <div class="main-title">
                                    <h3 class="mb-0"><?php echo app('translator')->get('admin.postal_receive_list'); ?> </h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $postal_receives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $postal_receive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td data-sort="<?php echo e(strtotime(@$postal_receive->date)); ?>">
                                                    <?php echo e(!empty($postal_receive->date) ? dateConvert(@$postal_receive->date) : ''); ?>
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <?php if(userPermission(29)): ?>
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(url('postal-receive', [@$postal_receive->id])); ?>"><?php echo app('translator')->get('common.edit'); ?></a>
                                                            <?php endif; ?>
                                                            <?php if(userPermission(30)): ?>

                                                                <a class="dropdown-item" data-toggle="modal"
                                                                    data-target="#deletePostalReceiveModal<?php echo e(@$postal_receive->id); ?>"
                                                            ...
                                                            <?php if(@$postal_receive->file != ''): ?>
                                                                <?php if(userPermission(31)): ?>
                                                                    <?php if(@file_exists($postal_receive->file)): ?>
                                                                        <a class="dropdown-item"
                                                                            href="<?php echo e(url(@$postal_receive->file)); ?>" download>
                                            ...
                                            <div class="modal fade admin-query"
                                                id="deletePostalReceiveModal<?php echo e($postal_receive->id); ?>">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title"><?php echo app('translator')->get('admin.delete_postal_receive'); ?>
                                                            </h4>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/admin/postal_receive.blade.php ENDPATH**/ ?>