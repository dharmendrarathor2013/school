    ...
    <div class="container-fluid">
        <div class="row justify-content-between">
            ...
            <div class="bc-pages">
                ...
                <a href="<?php echo e(route('sms-settings')); ?>"><?php echo app('translator')->get('system_settings.backup_settings'); ?></a>
            </div>
        </div>
    </div>
</section>
                                ...
                                <div class="row no-gutters input-right-icon mb-20">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            placeholder="<?php echo e(isset($editData->file) && @$editData->file != ""? getFilePath3(@$editData->file): trans('common.attach_file') . "*"); ?> "  id="placeholderUploadContent" name="content_file">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4  col-xl-3">
                        <div class="main-title mb-20" >
                            <h3 class="mb-0"> <?php echo app('translator')->get('system_settings.database_backup_list'); ?></h3>
                        </div>
                    </div>
                    ...
                    <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip" title="<?php echo app('translator')->get('system_settings.disabled_image_backup'); ?>">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" > <?php echo app('translator')->get('system_settings.upload_file_backup'); ?></button>
                    </span>
                       
                          <span class="d-inline-block mb-10" tabindex="0" data-toggle="tooltip" title="<?php echo app('translator')->get('system_settings.disabled_database_backup'); ?>">
                            <button class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;" type="button" ><?php echo app('translator')->get('system_settings.database_backup'); ?></button>
                          </span>
                    <?php else: ?>
                        ...
                        <?php if(userPermission(462)): ?>
                             <a href="<?php echo e(route('get-backup-db')); ?>" class="primary-btn small fix-gr-bg demo_view"> <span class="ti-arrow-circle-down pr-2"></span> <?php echo app('translator')->get('system_settings.database_backup'); ?> </a>
                        <?php endif; ?> 
                <?php endif; ?> 
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/systemSettings/backupSettings.blade.php ENDPATH**/ ?>