            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main-title">
                        <h3 class="mb-30"><?php echo app('translator')->get('homework.add_homework'); ?></h3>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-12 " id="selectSectionsDiv" style="margin-top: -25px;">
                                        <label for="checkbox" class="mb-2"><?php echo app('translator')->get('common.section'); ?> *</label>
                                            ...
                                            <label for="checkbox_section" class="mt-3"><?php echo app('translator')->get('homework.select_all'); ?></label>
                                            </div>
                            ...
                            <div class="row mb-30">
                                        ...
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input date form-control<?php echo e($errors->has('homework_date') ? ' is-invalid' : ''); ?>"
                                                       ...
                                                       readonly>
                                                <label><?php echo app('translator')->get('homework.home_work_date'); ?>
                                                    <span>*</span></label>
                                                <span class="focus-border"></span>
                                        ...
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input date form-control<?php echo e($errors->has('submission_date') ? ' is-invalid' : ''); ?>"
                                                       ...
                                                       readonly>
                                                <label><?php echo app('translator')->get('homework.submission_date'); ?>
                                                    <span>*</span></label>
                                                <span class="focus-border"></span>
                                ...
                                <div class="col-lg-3">
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input oninput="numberCheckWithDot(this)" class="primary-input form-control<?php echo e($errors->has('marks') ? ' is-invalid' : ''); ?>"
                                                       type="text" name="marks" value="<?php echo e(old('marks')); ?>">
                                                <label><?php echo app('translator')->get('homework.marks'); ?> <span>*</span></label>
                                                <span class="focus-border"></span>
                                        ...
                                        <div class="col-auto">
                                            <button class="primary-btn-small-input" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                       for="homework_file"><?php echo app('translator')->get('common.browse'); ?></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/homework/addHomework.blade.php ENDPATH**/ ?>