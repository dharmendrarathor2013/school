                        ...
                        <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'subject-attendance-search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_studentA'])); ?>
                            ...
                            <div class="col-lg-3 mt-30-md md_mb_20" id="select_subject_div">
                                <select class="w-100 bb niceSelect form-control<?php echo e($errors->has('subject') ? ' is-invalid' : ''); ?> select_subject" id="select_subject" name="subject">
                                    <option data-display="<?php echo app('translator')->get('student.select_subject'); ?> *" value=""><?php echo app('translator')->get('student.select_subject'); ?> *</option>
                                </select>
                                ...
                                <div class="row no-gutters input-right-icon">
                                    <div class="col">
                                        <div class="input-effect">
                                            ...
                                            <label for="startDate"><?php echo app('translator')->get('student.attendance_date'); ?>*</label>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-30"><?php echo app('translator')->get('student.student_attendance'); ?> | <small><?php echo app('translator')->get('common.class'); ?>: <?php echo e($search_info['class_name']); ?>, <?php echo app('translator')->get('common.section'); ?>: <?php echo e($search_info['section_name']); ?>, <?php echo app('translator')->get('common.date'); ?>: <?php echo e(dateConvert($search_info['date'])); ?></small></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/studentInformation/subject_attendance.blade.php ENDPATH**/ ?>