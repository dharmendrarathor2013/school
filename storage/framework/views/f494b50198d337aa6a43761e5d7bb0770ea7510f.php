                        ...
                        <div class="col-lg-12">
                            ...
                            <?php else: ?>
                                <?php if(userPermission(37)): ?>
                                    <?php echo e(Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'phone-call', 'method' => 'POST', 'enctype' => 'multipart/form-data'])); ?>
                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('common.name'); ?></label>
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                ...
                                                <label><?php echo app('translator')->get('admin.phone'); ?> <span>*</span></label>
                                                <span class="focus-border"></span>
                                        ...
                                        <div class="col">
                                            <div class="input-effect">
                                                <input
                                                    ...
                                                    autocomplete="off">
                                                <span class="focus-border"></span>
                                                <label><?php echo app('translator')->get('admin.follow_up_date'); ?> <span></span></label>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <button class="" type="button">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <input
                                                    class="primary-input form-control<?php echo e(@$errors->has('call_duration') ? ' is-invalid' : ''); ?>"
                                                ...
                                                <label><?php echo app('translator')->get('admin.call_duration'); ?></label>
                                                <span class="focus-border"></span>
                                            ...
                                            <div class="input-effect">
                                                <?php if(isset($phone_call_log)): ?>
                                                    <textarea class="primary-input form-control" cols="0" rows="4"
                                                        name="description"> <?php echo e(@$phone_call_log->description); ?></textarea>
                                                <?php else: ?>
                                                    <textarea class="primary-input form-control" cols="0" rows="4"
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-lg-4 no-gutters">
                                <div class="main-title">
                                    <h3 class="mb-0"><?php echo app('translator')->get('admin.phone_call_list'); ?></h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $phone_call_logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phone_call_log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(trans('admin.'.($phone_call_log->call_type == 'I' ? 'incoming' : 'outgoing'))); ?></td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <?php if(userPermission(38)): ?>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('phone-call_edit', @$phone_call_log->id)); ?>"><?php echo app('translator')->get('common.edit'); ?></a>
                                                            <?php endif; ?>
                                                            <?php if(userPermission(39)): ?>

                                                                <a class="dropdown-item" data-toggle="modal"
                                                                    data-target="#deleteCallLogModal<?php echo e(@$phone_call_log->id); ?>"
                                            ...
                                            <div class="modal fade admin-query"
                                                id="deleteCallLogModal<?php echo e(@$phone_call_log->id); ?>">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-40 d-flex justify-content-between">
                                                                ...
                                                                <?php echo e(Form::open(['route' => ['phone-call_delete', @$phone_call_log->id], 'method' => 'DELETE', 'enctype' => 'multipart/form-data'])); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/admin/phone_call.blade.php ENDPATH**/ ?>