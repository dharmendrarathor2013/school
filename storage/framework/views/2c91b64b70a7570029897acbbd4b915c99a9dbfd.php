                        ...
                        <div class="white-box">
                            <div class="add-visitor">
                                <div class="row">
                                  ...
                                  <div class="row mt-30">
                                        <div class="col-lg-12">
                                            <label><?php echo app('translator')->get('common.branches'); ?></label><br>
...
<!-- 
                                                        <label for="branch<?php echo e(@$branch->id); ?>"><?php echo app('translator')->get('academics.branch'); ?> <?php echo e(@$branch->branch_name); ?></label> -->
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/academics/section.blade.php ENDPATH**/ ?>