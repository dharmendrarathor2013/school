                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('transport.vehicle_number'); ?> <span>*</span></label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('transport.vehicle_model'); ?> <span>*</span></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('transport.year_made'); ?></label>
                                            <span class="focus-border"></span>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="input-effect">
                                            ...
                                            <label><?php echo app('translator')->get('transport.note'); ?></label>
            ...
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-4 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0">  <?php echo app('translator')->get('transport.vehicle_list'); ?></h3>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/transport/vehicle.blade.php ENDPATH**/ ?>