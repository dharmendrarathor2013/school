                                    ...
                                    <select class="w-100 bb niceSelect form-control<?php echo e($errors->has('section') ? ' is-invalid' : ''); ?> select_section" id="select_section" name="section">
                                        ...
                                        <?php if(isset($class_id)): ?>
                                            <?php $__currentLoopData = $search_current_class->classSection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option  value="<?php echo e($section->sectionName->id); ?>"  <?php echo e(( ($section_id  == $section->sectionName->id) ? "selected":"")); ?>><?php echo e($section->sectionName->section_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
    ...
    <div class="container-fluid p-0">
        <div class="row mt-40">
            <div class="col-lg-8 col-md-8">
                <div class="main-title">
                    <h3 class="mb-30"><?php echo app('translator')->get('exam.exam_schedule'); ?> | 
                                                        <small>
                                     ...
                                     <?php echo app('translator')->get('common.section'); ?>: <?php echo e(@$search_current_section !='' ? $search_current_section->section_name : 'All Sections'); ?>,
            ...
            <div class="col-lg-4  col-md-4 ">
              <a href="<?php echo e(route('exam-routine-print', [$class_id, $section_id,$exam_type_id])); ?>" class="primary-btn small fix-gr-bg pull-left" target="_blank"><i class="ti-printer"> </i> <?php echo app('translator')->get('common.print'); ?></a>
                    <button  class="primary-btn small fix-gr-bg pull-right" onclick="addRowInExamRoutine();" id="addRowBtn"> <span class="ti-plus pr-2"></span> <?php echo app('translator')->get('common.add'); ?></button>
            </div>
        </div>
                            ...
                            <tr class="0" id="row_<?php echo e($row); ?>">
                                <td  class="border-top-0">
                                    <div class="input-effect" >
                                            <select class="niceSelect  w-100 bb form-control" name="routine[<?php echo e($row); ?>][subject]" id="subject" data-rule-required="true" required >
                                                ...
                                                <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <option value="<?php echo e($subject->id); ?>" <?php echo e($routine->subject_id == $subject->id ?'selected':''); ?>><?php echo e(@$subject->subject_name); ?></option>
                                 ...
                                 <div class="row">
                                            <div class="col-lg-12">
                                              ...
                                              <select class="w-100 bb niceSelect form-control  <?php echo e($errors->has('class') ? ' is-invalid' : ''); ?> promote_class" readonly disabled  id="promote_class" name="routine[<?php echo e($row); ?>][class]" required>
                                               <option data-display="<?php echo app('translator')->get('common.select_class'); ?> *" value=""><?php echo app('translator')->get('common.select_class'); ?> *</option>
                                               <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td class="border-top-0">
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="col-lg-12" id="promote_section_div">
                                               ...
                                               <select class="w-100 bb niceSelect form-control<?php echo e($errors->has('section') ? ' is-invalid' : ''); ?>"   name="routine[<?php echo e($row); ?>][section]" required>
                                                ...
                                                <option data-display="<?php echo app('translator')->get('common.select_section'); ?> *" value=""><?php echo app('translator')->get('common.select_section'); ?> *
                                                    ...
                                                    <?php $__currentLoopData = $search_current_class->classSection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option  value="<?php echo e($section->sectionName->id); ?>"  <?php echo e(( ($routine->section_id  == $section->sectionName->id) ? "selected":"")); ?>><?php echo e($section->sectionName->section_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="row " id="teacher-div">
                                        <div class="col-lg-12 mt-30-md">
                                            <select class="niceSelect w-100 bb form-control" name="routine[<?php echo e($row); ?>][teacher_id]" >
                                ...
                                <td class="border-top-0">
                                     <div class="row no-gutters input-right-icon">
                                         <div class="col">
                                            ...
                                            <div class="input-effect">
                                                <input class="primary-input date form-control<?php echo e(@$errors->has('date') ? ' is-invalid' : ''); ?>" id="startDate" type="text" name="routine[<?php echo e($row); ?>][date]" value="<?php echo e(isset($routine)?  date('m/d/Y', strtotime(@$routine->date)) : date('m/d/Y')); ?>" autocomplete="off" required>
                                                <span class="focus-border"></span>
                                ...
                                <td class="border-top-0">  
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input time start_time_required  form-control<?php echo e(@$errors->has('start_time') ? ' is-invalid' : ''); ?>" type="text" name="routine[<?php echo e($row); ?>][start_time]"  value="<?php echo e(isset($routine)? $routine->start_time: ''); ?>" required>
                                ...
                                <td class="border-top-0">   
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input time  form-control<?php echo e(@$errors->has('end_time') ? ' is-invalid' : ''); ?>" type="text" name="routine[<?php echo e($row); ?>][end_time]"  value="<?php echo e(isset($routine)? $routine->end_time: ''); ?>" required>
                                                <label style="top: -13;"><?php echo app('translator')->get('exam.end_time'); ?> *</label>
                                                <span class="focus-border"></span>
                                ...
                                <td class="border-top-0">   
                                    <div class="row">
                                        <div class="col-lg-12 mt-30-md">
                                            <select class="niceSelect w-100 bb form-control" name="routine[<?php echo e($row); ?>][room]" id="room" required>
                                    ...
                                    <td class="border-top-0">
                                        ...
                                        <?php if(userPermission(249)): ?>
                                            ...
                                            <button class="primary-btn icon-only fix-gr-bg removeExamRoutineRowBtn" data-row_id="<?php echo e($row); ?>" data-exam_routine_id="<?php echo e($routine->id); ?>" type="button">
        ...
        var tr=`<tr class="0" id="row_${row_count}">
                                ...
                                <td class="border-top-0">
                                        <div class="row">
                                            <div class="col-lg-12">
                                              ...
                                              <select class="w-100 bb niceSelect form-control  <?php echo e($errors->has('class') ? ' is-invalid' : ''); ?> promote_class" readonly disabled  id="promote_class" name="routine[${row_count}][class]" required>
                                                <option data-display="<?php echo app('translator')->get('common.select_class'); ?> *" value=""><?php echo app('translator')->get('common.select_class'); ?> *</option>
                                                    <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e(@$class->id); ?>"  <?php echo e(( ($class_id  == $class->id) ? "selected":"")); ?>><?php echo e($class->class_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <td class="border-top-0">
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                               ...
                                               <select class="w-100 bb niceSelect form-control<?php echo e($errors->has('section') ? ' is-invalid' : ''); ?>" name="routine[${row_count}][section]" required>
                                ...
                                <td class="border-top-0">
                                     <div class="row no-gutters input-right-icon">
                                         <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input date form-control<?php echo e(@$errors->has('date') ? ' is-invalid' : ''); ?>" id="startDate" type="text" name="routine[${row_count}][date]" value="<?php echo e(date('m/d/Y')); ?>" autocomplete="off">
                                                <span class="focus-border"></span>
                                                <label style="top: -13px;"><?php echo app('translator')->get('common.date'); ?> <span></span></label>
                                                <?php if($errors->has('date')): ?>
                                                <span class="invalid-feedback" role="alert">
                                                    <strong><?php echo e(@$errors->first('date')); ?></strong>
                                                </span>
                                ...
                                <td class="border-top-0">  
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input time form-control<?php echo e(@$errors->has('start_time') ? ' is-invalid' : ''); ?>" type="text" name="routine[${row_count}][start_time]" required>
                                                <label style="top: -13px;"><?php echo app('translator')->get('academics.start_time'); ?> *</label>
                                                <span class="focus-border"></span>
                                                <span class="text-danger start_time_error"></span> 
                                            </div>
                                        </div>
                                ...
                                <td class="border-top-0">   
                                    <div class="row no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="input-effect">
                                                <input class="primary-input time   form-control<?php echo e(@$errors->has('end_time') ? ' is-invalid' : ''); ?>" type="text" name="routine[${row_count}][end_time]" required>
                                                <label style="top: -13px;"><?php echo app('translator')->get('exam.end_time'); ?> *</label>
                                                <span class="focus-border"></span>
                                                <span class="text-danger end_time_error"></span> 
                                            </div>
                                        </div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/examination/exam_schedule_new_update.blade.php ENDPATH**/ ?>