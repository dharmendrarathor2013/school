                        ...
                        <div class="white-box">
                                <?php if(session()->has('message-success')): ?>
                                    <div class="alert alert-success">
                                        <?php echo app('translator')->get('system_settings.inserted_message'); ?>
                                    </div>
                                <?php elseif(session()->has('message-danger')): ?>
                                    <div class="alert alert-danger">
                                        <?php echo app('translator')->get('system_settings.error_message'); ?>
                                    </div>
                                <?php endif; ?>
                                <div class="row">
                                    <div class="col-lg-12">
            ...
            <form action="<?php echo e(route('set_fcm_key')); ?>" method="post">
                ...
                <div class="col-lg-6 mb-20">
                            <div class="input-effect ">
                                ...
                                <label><?php echo app('translator')->get('system_settings.fcm_key'); ?> <span>*</span></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/systemSettings/apiPermission.blade.php ENDPATH**/ ?>