                                ...
                                <form action="<?php echo e(route('chat.group.create')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="chat_view_list_inner_scrolled" style="overflow: unset;">
                                        <div class="primary_input mb_20">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('chat::chat.group_name'); ?> *</label>
                                            ...
                                            <div class="row no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                                        <input class="primary-input" type="text" id="placeholderGroupPhoto" placeholder="<?php echo app('translator')->get('chat::chat.group_photo'); ?>" readonly="">
                                                        <span class="focus-border"></span>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
                                                    <button class="primary-btn-small-input" type="button">
                                                        <label class="primary-btn small fix-gr-bg" for="group_photo"><?php echo app('translator')->get('common.browse'); ?></label>
                                        ...
                                        <div class="primary_input mb-15 mt-5">
                                            <label class="primary_input_label" for=""><?php echo app('translator')->get('common.member'); ?> *</label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/impact-eschool-erp-main/Modules/Chat/Resources/views/group/create.blade.php ENDPATH**/ ?>