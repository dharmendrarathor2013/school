                ...
                <div class="col-lg-12">
                    <div class="main-title">
                        <?php if(moduleStatusCheck('SaasSubscription') && moduleStatusCheck('Saas') && auth()->user()->role_id == 1): ?>
                            <h3 class="mb-0"><?php echo app('translator')->get('dashboard.welcome'); ?> - <?php echo e(@Auth::user()->school->school_name); ?> | <?php echo e(@Auth::user()->roles->name); ?> |
                        ...
                        <?php else: ?>
                            <h3 class="mb-0"><?php echo app('translator')->get('dashboard.welcome'); ?> - <?php echo e(@Auth::user()->school->school_name); ?> | <?php echo e(@Auth::user()->roles->name); ?></h3>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-lg-8 col-md-9 col-8">
                        <div class="main-title">
                            <h3 class="mb-30"> <?php echo app('translator')->get('dashboard.income_and_expenses_for'); ?> <?php echo e(date('M')); ?> <?php echo e($year); ?> </h3>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-2 col-md-6 col-6">
                                    <div class="text-center">
                                        ...
                                        ?>
                                        <h1><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format($m_total_income, 2)); ?></h1>
                                        <p><?php echo app('translator')->get('dashboard.total_income'); ?></p>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-6">
                                    <div class="text-center">
                                        <h1><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format($m_total_expense, 2)); ?></h1>
                                        <p><?php echo app('translator')->get('dashboard.total_expenses'); ?></p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-6">
                                    <div class="text-center">
                                        <h1><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format($m_total_income - $m_total_expense, 2)); ?></h1>
                                ...
                                <?php if(moduleStatusCheck('Wallet')): ?>
                                    <div class="col-lg-2 col-md-6 col-6">
                                        <div class="text-center">
                                            <h1><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format($monthlyWalletBalance,2,'.','')); ?></h1>
        ...
        <section class="mt-50" id="incomeExpenseSessionDiv">
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-lg-8 col-md-9 col-8">
                        <div class="main-title">
                            <h3 class="mb-30"><?php echo app('translator')->get('dashboard.income_and_expenses_for'); ?> <?php echo e($year); ?></h3>
                        </div>
                    </div>
                    <div class="offset-lg-2 col-lg-2 text-right col-md-3 col-4">
                    ...
                    <div class="col-lg-12">
                        <div class="white-box" id="areaChartDiv">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-6">
                                    <div class="text-center">
                                        <h1><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format($y_total_income, 2)); ?></h1>
                                        <p><?php echo app('translator')->get('dashboard.total_income'); ?></p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-6 col-6">
                                    <div class="text-center">
                                        ...
                                        <h1><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format($y_total_expense, 2)); ?></h1>
                                        <p><?php echo app('translator')->get('dashboard.total_expenses'); ?></p>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-6">
                                    <div class="text-center">
                                        <h1><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format($y_total_income - $y_total_expense, 2)); ?></h1>
                                        <p><?php echo app('translator')->get('dashboard.total_profit'); ?></p>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-6 col-6">
                                ...
                                <?php if(moduleStatusCheck('Wallet')): ?>
                                    <div class="col-lg-2 col-md-6 col-6">
                                        <div class="text-center">
                                            <h1><?php echo e(generalSetting()->currency_symbol); ?><?php echo e(number_format($yearlyWalletBalance,2,'.','')); ?></h1>
                                            <p><?php echo app('translator')->get('dashboard.wallet_balance'); ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
        ...
        <section class="mt-50">
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-lg-10">
                        <div class="main-title">
                            <h3 class="mb-30"><?php echo app('translator')->get('communicate.notice_board'); ?></h3>
                        </div>
                    </div>
                    <div class="col-lg-2 pull-right text-right">
                        <a href="<?php echo e(route('add-notice')); ?>" class="primary-btn small fix-gr-bg"> <span class="ti-plus pr-2"></span> <?php echo app('translator')->get('common.add'); ?> </a>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <table class="school-table-style w-100">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('view-notice',@$notice->id)); ?>" title="<?php echo app('translator')->get('common.view_notice'); ?>"  class="primary-btn small tr-bg modalLink" data-modal-size="modal-lg"><?php echo app('translator')->get('common.view'); ?></a>
                                </td>
                            </tr>
                            <?php
                            }
                            ...
                            <div class="col-lg-12">
                                <div class="main-title">
                                    ...
                                    <div id="eventContent" title="Event Details" style="display:none;">
                                        <?php echo app('translator')->get('common.start'); ?>: <span id="startTime"></span><br>
                                        <?php echo app('translator')->get('dashboard.end'); ?>: <span id="endTime"></span><br><br>
                                        <p id="eventInfo"></p>
                                        <p><strong><a id="eventLink" href="" target="_blank"><?php echo app('translator')->get('dashboard.read_more'); ?></a></strong></p>
                                    </div>


                                    <h3 class="mb-30"><?php echo app('translator')->get('dashboard.calendar'); ?></h3>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <?php if(userPermission(10)): ?>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-6">
                                <div class="main-title">
                                    <h3 class="mb-30"><?php echo app('translator')->get('dashboard.to_do_list'); ?></h3>
                                </div>
                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row mt-25">
                                                    <div class="col-lg-12" id="sibling_class_div">
                                                        <div class="input-effect">
                                                            ...
                                                            <label><?php echo app('translator')->get('dashboard.to_do_title'); ?> *<span></span> </label>
                                                ...
                                                <div class="col-lg-12 text-center">
                                                    <div class="mt-40 d-flex justify-content-between">
                                                        ...
                                                        <input class="primary-btn fix-gr-bg submit" type="submit" value="<?php echo app('translator')->get('dashboard.save'); ?>">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="white-box school-table">
                                <div class="row to-do-list mb-20">
                                    <div class="col-md-12 d-flex align-items-center justify-content-between ">
                                        <button class="primary-btn small fix-gr-bg" id="toDoList"><?php echo app('translator')->get('dashboard.incomplete'); ?></button>
                                        <button class="primary-btn small tr-bg" id="toDoListsCompleted"><?php echo app('translator')->get('dashboard.completed'); ?></button>
                                    </div>
                                </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/dashboard.blade.php ENDPATH**/ ?>