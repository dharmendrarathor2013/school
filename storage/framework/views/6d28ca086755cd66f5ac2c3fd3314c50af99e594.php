                                                                            ...
                                                                            <div class="card_text_head hStudentName" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:10px"> 
                                                                                <div class="card_text_left">
                                                                                    <?php if($id_card->father_name ==1): ?>
                                                                                        <div id="hFatherName">
                                                                                            <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500"><?php echo app('translator')->get('student.father_name'); ?> : InfixEdu</h4>
                                                                                        </div>
                                                                                    <?php endif; ?>
                                                                                    <?php if($id_card->mother_name==1): ?>
                                                                                        <div id="hMotherName">
                                                                                            <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 0; font-size:10px; font-weight:500"><?php echo app('translator')->get('student.mother_name'); ?> : InfixEdu</h4>
                                                                                        </div>
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="card_text" style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; flex-direction: column;">
                                                                            ...
                                                                            <div class="card_text_head " style="line-height:1.02; display: flex; align-items: center; justify-content: space-between; width: 100%; margin-bottom:5px"> 
                                                                                <div class="card_text_left">
                                                                                    <?php if($id_card->father_name ==1): ?>
                                                                                        <div id="vFatherName">
                                                                                            <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500"><?php echo app('translator')->get('student.father_name'); ?> : InfixEdu</h3>
                                                                                        </div>
                                                                                    <?php endif; ?>
                                                                                    <?php if($id_card->mother_name==1): ?>
                                                                                        <div id="vMotherName">
                                                                                            <h3 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px; font-weight:500"><?php echo app('translator')->get('student.mother_name'); ?> : InfixEdu</h3>
                                                                                        </div>
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                                <div class="card_text_right">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/admin/idCard/student_id_card_list.blade.php ENDPATH**/ ?>