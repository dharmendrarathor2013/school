                ...
                <div class="row">
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <div class="input-effect">
                                    ...
                                    <label><?php echo app('translator')->get('admin.grid_gap'); ?> (px) <span>*</span></label>
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-2 no-gutters">
                        <div class="main-title">
                            <h3 class="mb-0"><?php echo app('translator')->get('studentInfo.student_list'); ?></h3>
                        </div>
                    </div>
                    <div class="col-lg-1">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/admin/idCard/generate_id_card.blade.php ENDPATH**/ ?>