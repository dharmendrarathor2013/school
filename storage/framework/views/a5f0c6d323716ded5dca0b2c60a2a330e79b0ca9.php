...
<?php $__env->startSection('mainContent'); ?>
                                ...
                                <div class="add-visitor">
                                    <div class="row">
                                        <div class="col-lg-12 mb-30">
                                            <select
                                                class="niceSelect w-100 bb form-control<?php echo e($errors->has('member_type') ? ' is-invalid' : ''); ?>"
                                                ...
                                                <?php if(isset($leave_define)): ?>
                                                    <?php if(!is_null($student)): ?>
                                                        <option value="<?php echo e(@$student->role_id); ?>" selected>
                                                            <?php echo e(@$student->roles->name); ?></option>
                                                    <?php endif; ?>
                                        ...
                                        <div class="forStudentWrapper col-lg-12">
                                            <div class="row">
                                                <div class="col-lg-12 mb-30">
                                                    <select
                                                        ...
                                                        <?php if(!isset($leave_define)): ?>
                                                            ...
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php else: ?>
                                                            <?php if(isset($student) && $student->defaultClass): ?>
                                                                <option value="<?php echo e(@$student->class_id); ?>" selected>
                                                                    <?php echo e(@$student->defaultClass->class->class_name); ?>
                                                ...
                                                <div class="col-lg-12 mb-30" id="select_section__member_div">
                                                    <select
                                                        class="w-100 bb niceSelect form-control<?php echo e($errors->has('section') ? ' is-invalid' : ''); ?>"
                                                        ...
                                                        <?php if(isset($student) && $student->defaultClass): ?>
                                                            <option value="<?php echo e(@$$student->defaultClass->section_id); ?>"
                                                                selected>
                                                                <?php echo e(@$student->defaultClass->section->section_name); ?>
                                                ...
                                                <div class="col-lg-12 mb-30" id="select_student_div">
                                                    <select
                                                        class="w-100 bb niceSelect form-control<?php echo e($errors->has('student') ? ' is-invalid' : ''); ?>"
                                        ...
                                        <div class="col-lg-12 mb-30" id="selectStaffsDiv">
                                            <select
                                                class="niceSelect w-100 bb form-control<?php echo e($errors->has('staff_id') ? ' is-invalid' : ''); ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <select
                                                class="niceSelect w-100 bb form-control<?php echo e($errors->has('leave_type') ? ' is-invalid' : ''); ?>"
                                                name="leave_type">
                                    ...
                                    <div class="row mt-20">
                                        <div class="col-lg-12">
                                            <div class="input-effect">
                                                <input
                                                    class="primary-input form-control<?php echo e($errors->has('days') ? ' is-invalid' : ''); ?>"
                                                    type="text" name="days" autocomplete="off"
                                                    value="<?php echo e(isset($leave_define) ? $leave_define->days : ''); ?>">
                                                <label><?php echo app('translator')->get('leave.days'); ?> <span>*</span> </label>
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-lg-4 no-gutters">
                            <div class="main-title">
                                <h3 class="mb-0"><?php echo app('translator')->get('leave.leave_define_list'); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center">
                        <?php echo app('translator')->get('common.are_you_sure_to_delete'); ?>
                    </div>
    ...
    <div class="modal fade admin-query" id="addLeaveDayModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo app('translator')->get('leave.update_leave_define'); ?> </h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="mt-40 d-flex justify-content-between">
                        ...
                        <button class="primary-btn fix-gr-bg" type="submit"><?php echo app('translator')->get('common.update'); ?></button>
                    </div>
                    <?php echo e(Form::close()); ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/impactinstitute.in/dev.impactinstitute.in/resources/views/backEnd/humanResource/leave_define.blade.php ENDPATH**/ ?>